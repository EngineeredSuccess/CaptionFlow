          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="text-center lg:text-left space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start pt-4">
                ...
                <Link href="/pricing">
                  <Button size="lg" variant="outline" className="h-14 px-10 text-lg rounded-2xl border-zinc-200 dark:border-zinc-800 text-zinc-600 dark:text-zinc-400 hover:bg-zinc-50 dark:hover:bg-zinc-900 transition-colors">
                    Pricing
                  </Button>
                </Link>
          ...
          <div className="grid md:grid-cols-4 gap-12 mb-16">
            ...
            <div>
              ...
              <ul className="space-y-4 text-sm font-medium">
                <li><Link href="/register" className="text-primary font-bold hover:underline">Get Started ✨</Link></li>
